...
#define AD9834_FSYNC GPIO_PIN_14
#define AD9834_SCLK GPIO_PIN_13
#define AD9834_SDATA GPIO_PIN_15
#define AD9834_RESET GPIO_PIN_12
...
void AD9834_Select_Wave(unsigned int initdata);                      // 选择输出波形                                     // 初始化配置
